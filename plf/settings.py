# Django settings for plf project.
...
ALLOWED_HOSTS = ['plf.herokuapp.com', 'plf.tigerapps.org']
...
MEDIA_URL = 'https://s3-us-west-2.amazonaws.com/plfpictures/photos/'
...
ROOT_URLCONF = 'plf.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'plf.wsgi.application'
